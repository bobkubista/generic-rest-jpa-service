package com.bobkubista.domain.validators;

import com.bobkubista.domain.validator.XorFields;
...
public class MockXorFieldsObject {
    ...
    public MockXorFieldsObject(final String first, final String seccond) {
        this.first = first;
        this.second = seccond;
    }
