package com.bobkubista.domain.api.server;
 ...
 *            The idertifier
 */
public interface ActiveServerApi<DMO extends ActiveDomainObject<ID>, ID extends Serializable> extends FunctionalIdentifiableServerApi<DMO, ID> {
